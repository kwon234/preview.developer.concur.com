...
<h3 id="manyusingget-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|invoiceId|undefined|string|false|InvoiceId|
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|erpDocumentNumber|string|false|none|ErpDocumentNumber of that invoice.Maximum 20 characters.|
