...
<h3 id="getreportcommentsusingget-responseschema">Response Schema</h3>
...
`GET /expensereports/v4/users/{userId}/context/{contextType}/reports/{reportId}/expenses/{expenseId}/comments`
...
|» canDelete|boolean|true|none|Indicates whether or not the expense entry can be deleted|
...
|»» listItemId|string|false|none|The unique identifier of the list item for this expense type|
...
|»» listItemUrl|string|false|none|href (string): The URL of the related HATEOAS link that you can use for subsequent calls|
...
|totalAmountPaid|[Amount](#schemaamount)|false|none|none|
...
|---|---|---|---|---|
|creditCardTransactionId|string|false|none|The unique identifier of the credit card transaction (indexed transactionId) associated with the expense|
|ereceipt|[EReceipt](#schemaereceipt)|false|none|none|
|expenseAttendees|[ExpenseAttendees](#schemaexpenseattendees)|false|none|none|
...
|trip|[Trip](#schematrip)|false|none|none|
...
|hasReceivedCashAdvanceReturns|boolean|false|none|Whether the Processor has received funds from the user for a cash advance return|
...
|receiptContainerId|string|false|none|The unique identifier of the physical location where the paper receipts are stored|
|redirectFund|[RedirectFund](#schemaredirectfund)|false|none|none|
...
|sponsorId|string|false|none|The unique identifier of the Employee, who is the official sponsor of the report owner|
...
<h2 id="tocS_CommentDetails">CommentDetails</h2>
<!-- backwards compatibility -->
<a id="schemacommentdetails"></a>
<a id="schema_CommentDetails"></a>
<a id="tocScommentdetails"></a>
<a id="tocscommentdetails"></a>
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|carEReceipt|[CarEReceipt](#schemacarereceipt)|false|none|none|
|hotelEReceipt|[HotelEReceipt](#schemahotelereceipt)|false|none|none|
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|airTrip|[AirTrip](#schemaairtrip)|false|none|none|
...
|carTrip|[CarTrip](#schemacartrip)|false|none|none|
...
|hotelTrip|[HotelTrip](#schemahoteltrip)|false|none|none|
|merchantCode|string|false|none|Merchant code associated with the trip. Maximum length: 4 characters|
|rideTrip|[RideTrip](#schemaridetrip)|false|none|none|
...
|businessPurpose|string|false|none|The text input for the business purpose by the user|
|canAllocate|boolean|true|none|Whether the expense can be allocated|
|canDelete|boolean|true|none|Indicates whether or not the expense entry can be deleted|
|claimedAmount|[Amount](#schemaamount)|false|none|none|
...
|expenseId|string|true|none|The unique identifier for the expense|
|expenseSourceIdentifiers|[ExpenseSourceIdentifiers](#schemaexpensesourceidentifiers)|false|none|none|
|expenseTaxSummary|[ExpenseTaxSummary](#schemaexpensetaxsummary)|false|none|none|
|expenseType|[ExpenseType](#schemaexpensetype)|true|none|none|
|hasBlockingExceptions|boolean|true|none|Whether the expense has any exceptions that blocks it from being submitted|
|hasExceptions|boolean|true|none|Whether the expense has any exceptions|
|hasMissingReceiptDeclaration|boolean|true|none|Whether the expense has an affidavit declaration for missing receipt|
...
|mileage|[Mileage](#schemamileage)|false|none|none|
|parentExpenseId|string|false|none|Expense Id of the parent expense|
|paymentType|[PaymentType](#schemapaymenttype)|true|none|none|
|postedAmount|[Amount](#schemaamount)|true|none|none|
|receiptImageId|string|false|none|The unique identifier of the image associated with the expense|
|receiptType|[ReceiptType](#schemareceipttype)|false|none|none|
...
|travelAllowance|[TravelAllowance](#schematravelallowance)|false|none|none|
|vendor|[Vendor](#schemavendor)|false|none|none|
|xmlReceiptId|string|false|none|The unique identifier of the XML receipt associated with the expense|
...
|comparisonFare|[Amount](#schemaamount)|false|none|none|
...
|reasonCodes|[string]|false|none|The Reason Code defines the reason for booked fare against the comparison fare.|
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|expenseTax1|[ExpenseTax](#schemaexpensetax)|true|none|none|
|expenseTax2|[ExpenseTax](#schemaexpensetax)|false|none|none|
...
|receiptImageId|string|false|none|The unique identifier of the image associated with the expense|
|receiptType|[ReceiptType](#schemareceipttype)|false|none|none|
|smartExpense|[SmartExpense](#schemasmartexpense)|false|none|none|
|tax|[Tax](#schematax)|false|none|none|
...
|amountCompanyPaid|[Amount](#schemaamount)|true|none|none|
|amountDueCompany|[Amount](#schemaamount)|true|none|none|
|amountDueCompanyCard|[Amount](#schemaamount)|true|none|none|
|amountDueEmployee|[Amount](#schemaamount)|true|none|none|
|amountNotApproved|[Amount](#schemaamount)|true|none|none|
...
|approvedAmount|[Amount](#schemaamount)|true|none|none|
|businessPurpose|string|false|none|The text input for the business purpose by the user|
|canAddExpense|boolean|true|none|Indicates whether an expense entry can be added to the report|
...
|claimedAmount|[Amount](#schemaamount)|true|none|none|
...
|isSentBack|boolean|true|none|Indicates whether the report has been sent back|
|isSubmitted|boolean|true|none|Indicates whether the report has been submitted|
...
|paymentConfirmedAmount|[Amount](#schemaamount)|true|none|none|
...
|personalAmount|[Amount](#schemaamount)|true|none|none|
...
|reportTotal|[Amount](#schemaamount)|true|none|none|
...
|submitterId|string|false|none|The unique identifier of the employee, who submitted the report|
|taxConfigId|string|false|none|The tax config ID of the report|
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|allocation|[UpdateAllocation](#schemaupdateallocation)|true|none|none|
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|netAdjustedTaxAmount|[Amount](#schemaamount)|false|none|none|
|netReclaimAdjustedAmount|[Amount](#schemaamount)|false|none|none|
|netReclaimAmount|[Amount](#schemaamount)|false|none|none|
|netTaxAmount|[Amount](#schemaamount)|false|none|none|
|totalReclaimAdjustedAmount|[Amount](#schemaamount)|false|none|none|
|totalReclaimPostedAmount|[Amount](#schemaamount)|false|none|none|
|totalTaxAdjustedAmount|[Amount](#schemaamount)|false|none|none|
|totalTaxPostedAmount|[Amount](#schemaamount)|false|none|none|
|vatTaxTotal|[Amount](#schemaamount)|false|none|none|
...
<h2 id="tocS_UpdateReportExpenseCompact">UpdateReportExpenseCompact</h2>
<!-- backwards compatibility -->
<a id="schemaupdatereportexpensecompact"></a>
<a id="schema_UpdateReportExpenseCompact"></a>
<a id="tocSupdatereportexpensecompact"></a>
<a id="tocsupdatereportexpensecompact"></a>
